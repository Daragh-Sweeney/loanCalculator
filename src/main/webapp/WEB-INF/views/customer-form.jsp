   ...
   <div class="panel panel-info">
    ...
    <div class="panel-body">
     <form:form action="saveCustomer" cssClass="form-horizontal" method="post" modelAttribute="customer">
      ...
      <div class="form-group">
       <label for="interest" class="col-md-3 control-label">InterestRate</label>
       <div class="col-md-9">
        <form:input path="interest" cssClass="form-control" required="true"/>
       </div>
      </div>
      
      <div class="form-group">
       <label for="years" class="col-md-3 control-label">Years</label>
       <div class="col-md-9">
        <form:input path="years" cssClass="form-control" required="true"/>
       </div>
      </div>
      ...
      <div class="form-group">
       ...
       <div class="col-md-9">
        <form:input path="amount" cssClass="form-control" required="true"/>
       </div>
      </div>
